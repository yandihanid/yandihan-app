  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ overflowX: 'hidden', backgroundColor: 'var(--bg-color)' }}>
      ...
      <header style={{ 
        ...
        <div className="container flex justify-between items-center" style={{ padding: '0.875rem 1.5rem' }}>
          ...
          <div className="flex gap-6 items-center">
            ...
            <Link href="#apk" style={{ color: 'var(--text-muted)', fontWeight: '600', fontSize: '0.95rem' }} className="hidden sm:inline">Aplikasi</Link>
      ...
      <main className="flex-col" style={{ flex: 1 }}>
        ...
        {/* Hero Section */}
        <section className="hero-section bg-gradient-primary" style={{ padding: '7rem 1rem 5rem' }}>
          <div className="container flex flex-col items-center animate-fade-in" style={{ position: 'relative', zIndex: 10 }}>
            ...
            <h1 style={{ 
              ...
              Tinggalkan Catatan Manual, Beralih ke Laporan <span style={{ color: 'transparent', backgroundImage: 'linear-gradient(90deg, var(--primary-color), #3B82F6)', WebkitBackgroundClip: 'text', backgroundClip: 'text' }}>Realtime.</span>
            </h1>
            ...
            <p style={{ 
              ...
              Solusi catat penjualan super instan via Link Web, Android APK, atau Telegram. Pantau omset harian dan bulanan langsung dari HP Anda tanpa ribet.
            </p>
            
            <div className="flex gap-4 flex-wrap justify-center">
              <Link href="/signup" className="btn btn-primary" style={{ padding: '0.875rem 2.25rem', fontSize: '1.05rem', borderRadius: '8px' }}>
                Mulai Gratis Sekarang <ArrowRight size={18} />
              </Link>
              <a href="/yandihan-kasir.apk" download className="btn btn-secondary" style={{ padding: '0.875rem 2.25rem', fontSize: '1.05rem', borderRadius: '8px', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                📲 Unduh APK Kasir
              </a>
            </div>
          </div>
          ...
          {/* Decorative Elements */}
          <div style={{ position: 'absolute', top: '20%', left: '10%', width: '300px', height: '300px', backgroundColor: 'rgba(37, 99, 235, 0.05)', borderRadius: '50%', filter: 'blur(80px)', zIndex: 0 }}></div>
          <div style={{ position: 'absolute', bottom: '10%', right: '10%', width: '400px', height: '400px', backgroundColor: 'rgba(59, 130, 246, 0.05)', borderRadius: '50%', filter: 'blur(100px)', zIndex: 0 }}></div>
        </section>
        ...
        {/* Pricing Section */}
        <section id="harga" style={{ padding: '6rem 1rem', backgroundColor: 'var(--bg-color)' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '4.5rem' }}>
              <h2 style={{ fontSize: '2.25rem', fontWeight: '800', color: 'var(--text-main)', marginBottom: '1rem', letterSpacing: '-1px' }}>Harga Transparan, Tanpa Kejutan</h2>
              <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto' }}>Pilih paket yang sesuai dengan ukuran bisnis Anda. Mulai dari gratis, upgrade kapan saja.</p>
            </div>
            ...
            <div style={{ 
              ...
              {/* Free Plan */}
              <div className="card" style={{ padding: '2.5rem 2rem', display: 'flex', flexDirection: 'column', borderRadius: '12px' }}>
                <div style={{ marginBottom: '1.75rem' }}>
                  <span style={{ backgroundColor: 'var(--border-color)', color: 'var(--text-main)', padding: '0.25rem 0.875rem', borderRadius: '99px', fontSize: '0.8rem', fontWeight: '700' }}>GRATIS</span>
                  ...
                  <p style={{ color: 'var(--text-muted)', marginTop: '0.5rem', fontSize: '0.875rem' }}>Cocok untuk UMKM pemula yang baru merintis bisnis.</p>
                </div>
              ...
              <div className="card" style={{ 
                ...
                <div style={{ marginBottom: '1.75rem' }}>
                  <span style={{ backgroundColor: 'var(--secondary-color)', color: 'var(--primary-color)', padding: '0.25rem 0.875rem', borderRadius: '99px', fontSize: '0.8rem', fontWeight: '700' }}>PRO</span>
                  ...
                  <p style={{ color: 'var(--text-muted)', marginTop: '0.5rem', fontSize: '0.875rem' }}>Untuk bisnis yang sedang berkembang dengan cabang/kasir banyak.</p>
                </div>
