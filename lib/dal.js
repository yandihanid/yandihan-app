...
const STORE_COLUMNS =
  'id, name, user_id, unique_code, subscription_tier, subscription_end_date, receipt_required, require_sub_product, require_customer_name, waiting_list_enabled, pelanggan_enabled, visit_threshold, discount_percent, created_at'
