...
export const PRO_FEATURES = [
  ...
  //
  // Laporan lanjutan digerbangi isPro() di app/dashboard/laporan/page.js dan
  // datanya berasal dari RPC agregat di supabase/migrations/0006_report_rpcs.sql.
  { label: 'Laporan lanjutan: produk terlaris, performa kasir, tren harian' },
